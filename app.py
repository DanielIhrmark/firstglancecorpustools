...
nltk_download("punkt", "punkt_tab", "averaged_perceptron_tagger", "averaged_perceptron_tagger_eng", "universal_tagset")
...
def main():
	...
	with st.sidebar:
		...
		st.info("75 Good Short Stories are availabe [here](https://americanliterature.com/short-short-stories/)")
